      ...
      <section className="section">
        <Container className="container">
          <div className="content">
            ...
            <Typography variant="h3">Forms stop working after upgrading to Gatsby v2</Typography>
            <Typography component="p">
              This can be caused by the offline-plugin.{" "}
              <LinkExternal title="Workaround" href="https://github.com/gatsbyjs/gatsby/issues/7997#issuecomment-419749232">
              </LinkExternal>{" "}
